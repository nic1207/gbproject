  ...
  <v-container class="ma-0" fluid>
    <v-row>
        ...
        <v-card>
          <div v-for="project in projects" :key="project.name" class="dashboard-card" flat>
            <v-layout>
              ...
              <v-flex mt-3 mb-2>
                <div class="white--text">
                  <span class="red--text">BP</span>
                  {{ project.tt }}
                </div>
              </v-flex>
              <v-flex mt-3 mb-2>
                <div class="white--text">
                  <span class="blue--text">PP</span>
                  {{ project.tt }}
                </div>
              </v-flex>
              <v-flex mt-2 mb-1>
                <v-btn class="white--text" small color="#c70000">
                  Ask B.
                </v-btn>
              </v-flex>
              <v-flex mt-2 mb-1>
                <v-btn class="white--text" small color="#2d30b1">
                  Ask P.
                </v-btn>
              ...
              <v-flex>
                <div class="white--text" style="background:#196260; height:50px;">
      ...
      <v-col cols="4" style="padding:0;">
        ...
        <v-row>
          <span class="subtitle-2 text-center pa-4  white--text " style="background:#876f4d; width:97%"><h3>Bet Information</h3></span>
        </v-row>
